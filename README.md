...
The intention of this example was to build an easy to use plotting tool for visualizing the values generated by AI controllers and see how their PID loops were affecting vehicles causing them to overshooting/undershooting or act unexpectedly.
